...
b=m(b);for(var h=e.split("."),i=0,j=h.length,k=b;j>i;i++)if(""!==h[i]||0!==i){if("^"!==h[i])break;if(!k.parent)throw new Error("Path '"+e+"' not valid for state '"+b.name+"'");k=k.parent}else k=b;h=h.slice(i).join("."),e=k.name+(k.name&&h?".":"")+h}var l=z[e];return!l||!d&&(d||l!==a&&l.self!==a)?c:l}function n(a,b){A[a]||(A[a]=[]),A[a].push(b)}function p(a){for(var b=A[a]||[];b.length;)q(b.shift())}function q(b){b=d(b,{self:b,resolve:b.resolve||{},toString:function(){return this.name}});var c=b.name;if(!N(c)||c.indexOf("@")>=0)throw new Error("State must have a valid name");if(z.hasOwnProperty(c))throw new Error("State '"+c+"' is already defined");var e=-1!==c.indexOf(".")?c.substring(0,c.lastIndexOf(".")):N(b.parent)?b.parent:O(b.parent)&&N(b.parent.name)?b.parent.name:"";if(e&&!z[e])return n(e,b.self);for(var f in C)M(C[f])&&(b[f]=C[f](b,C.$delegates[f]));return z[c]=b,!b[B]&&b.url&&a.when(b.url,["$match","$stateParams",function(a,c){y.$current.navigable==b&&j(a,c)||y.transitionTo(b,a,{inherit:!0,location:!1})}]),p(c),b}function r(a){return a.indexOf("*")>-1}function s(a){for(var b=a.split("."),c=y.$current.name.split("."),d=0,e=b.length;e>d;d++)"*"===b[d]&&(c[d]="*");return"**"===b[0]&&(c=c.slice(h(c,b[1])),c.unshift("**")),"**"===b[b.length-1]&&(c.splice(h(c,b[b.length-2])+1,Number.MAX_VALUE),c.push("**")),b.length!=c.length?!1:c.join("")===b.join("")}function t(a,b){return N(a)&&!L(b)?C[a]:M(b)&&N(a)?(C[a]&&!C.$delegates[a]&&(C.$delegates[a]=C[a]),C[a]=b,this):this}function u(a,b){return O(a)?b=a:b.name=a,q(b),this}function v(a,e,f,h,l,n,p,q,t){function u(b,c,d,f){var g=a.$broadcast("$stateNotFound",b,c,d);if(g.defaultPrevented)return p.update(),D;if(!g.retry)return null;if(f.$retry)return p.update(),E;var h=y.transition=e.when(g.retry);return h.then(function(){return h!==y.transition?A:(b.options.$retry=!0,y.transitionTo(b.to,b.toParams,b.options))},function(){return D}),p.update(),h}function v(a,c,d,g,i,j){function m(){var c=[];return Q(a.views,function(d,e){var g=d.resolve&&d.resolve!==a.resolve?d.resolve:{};g.$template=[function(){return f.load(e,{view:d,locals:i.globals,params:n,notify:j.notify})||""}],c.push(l.resolve(g,i.globals,i.resolve,a).then(function(c){if(M(d.controllerProvider)||P(d.controllerProvider)){var f=b.extend({},g,i.globals);c.$$controller=h.invoke(d.controllerProvider,null,f)}else c.$$controller=d.controller;c.$$state=a,c.$$controllerAs=d.controllerAs,i[e]=c}))}),e.all(c).then(function(){return i.globals})}var n=d?c:k(a.params.$$keys(),c),o={$stateParams:n};i.resolve=l.resolve(a.resolve,o,i.resolve,a);var p=[i.resolve.then(function(a){i.globals=a})];return g&&p.push(g),e.all(p).then(m).then(function(a){return i})}var A=e.reject(new Error("transition superseded")),C=e.reject(new Error("transition prevented")),D=e.reject(new Error("transition aborted")),E=e.reject(new Error("transition failed"));return x.locals={resolve:null,globals:{$stateParams:{}}},y={params:{},current:x.self,$current:x,transition:null},y.reload=function(a){return y.transitionTo(y.current,n,{reload:a||!0,inherit:!1,notify:!0})},y.go=function(a,b,c){return y.transitionTo(a,b,R({inherit:!0,relative:y.$current},c))},y.transitionTo=function(b,c,f){c=c||{},f=R({location:!0,inherit:!1,relative:null,notify:!0,reload:!1,$retry:!1},f||{});var g,j=y.$current,l=y.params,o=j.path,q=m(b,f.relative),r=c["#"];if(!L(q)){var s={to:b,toParams:c,options:f},t=u(s,j.self,l,f);if(t)return t;if(b=s.to,c=s.toParams,f=s.options,q=m(b,f.relative),!L(q)){if(!f.relative)throw new Error("No such state '"+b+"'");throw new Error("Could not resolve '"+b+"' from state '"+f.relative+"'")}}if(q[B])throw new Error("Cannot transition to abstract state '"+b+"'");if(f.inherit&&(c=i(n,c||{},y.$current,q)),!q.params.$$validates(c))return E;c=q.params.$$values(c),b=q;var z=b.path,D=0,F=z[D],G=x.locals,H=[];if(f.reload){if(N(f.reload)||O(f.reload)){if(O(f.reload)&&!f.reload.name)throw new Error("Invalid reload state object");var I=f.reload===!0?o[0]:m(f.reload);if(f.reload&&!I)throw new Error("No such reload state '"+(N(f.reload)?f.reload:f.reload.name)+"'");for(;F&&F===o[D]&&F!==I;)G=H[D]=F.locals,D++,F=z[D]}}else for(;F&&F===o[D]&&F.ownParams.$$equals(c,l);)G=H[D]=F.locals,D++,F=z[D];if(w(b,c,j,l,G,f))return r&&(c["#"]=r),y.params=c,S(y.params,n),S(k(b.params.$$keys(),n),b.locals.globals.$stateParams),f.location&&b.navigable&&b.navigable.url&&(p.push(b.navigable.url,c,{$$avoidResync:!0,replace:"replace"===f.location}),p.update(!0)),y.transition=null,e.when(y.current);if(c=k(b.params.$$keys(),c||{}),r&&(c["#"]=r),f.notify&&a.$broadcast("$stateChangeStart",b.self,c,j.self,l,f).defaultPrevented)return a.$broadcast("$stateChangeCancel",b.self,c,j.self,l),null==y.transition&&p.update(),C;for(var J=e.when(G),K=D;K<z.length;K++,F=z[K])G=H[K]=d(G),J=v(F,c,F===b,J,G,f);var M=y.transition=J.then(function(){var d,e,g;if(y.transition!==M)return A;for(d=o.length-1;d>=D;d--)g=o[d],g.self.onExit&&h.invoke(g.self.onExit,g.self,g.locals.globals),g.locals=null;for(d=D;d<z.length;d++)e=z[d],e.locals=H[d],e.self.onEnter&&h.invoke(e.self.onEnter,e.self,e.locals.globals);return y.transition!==M?A:(y.$current=b,y.current=b.self,y.params=c,S(y.params,n),y.transition=null,f.location&&b.navigable&&p.push(b.navigable.url,b.navigable.locals.globals.$stateParams,{$$avoidResync:!0,replace:"replace"===f.location}),f.notify&&a.$broadcast("$stateChangeSuccess",b.self,c,j.self,l),p.update(!0),y.current)},function(d){return y.transition!==M?A:(y.transition=null,g=a.$broadcast("$stateChangeError",b.self,c,j.self,l,d),g.defaultPrevented||p.update(),e.reject(d))});return M},y.is=function(a,b,d){d=R({relative:y.$current},d||{});var e=m(a,d.relative);return L(e)?y.$current!==e?!1:b?j(e.params.$$values(b),n):!0:c},y.includes=function(a,b,d){if(d=R({relative:y.$current},d||{}),N(a)&&r(a)){if(!s(a))return!1;a=y.$current.name}var e=m(a,d.relative);return L(e)?L(y.$current.includes[e.name])?b?j(e.params.$$values(b),n,g(b)):!0:!1:c},y.href=function(a,b,d){d=R({lossy:!0,inherit:!0,absolute:!1,relative:y.$current},d||{});var e=m(a,d.relative);if(!L(e))return null;d.inherit&&(b=i(n,b||{},y.$current,e));var f=e&&d.lossy?e.navigable:e;return f&&f.url!==c&&null!==f.url?p.href(f.url,k(e.params.$$keys().concat("#"),b||{}),{absolute:d.absolute}):null},y.get=function(a,b){if(0===arguments.length)return o(g(z),function(a){return z[a].self});var c=m(a,b||y.$current);return c&&c.self?c.self:null},y}function w(a,b,c,d,e,f){function g(a,b,c){function d(b){return"search"!=a.params[b].location}var e=a.params.$$keys().filter(d),f=l.apply({},[a.params].concat(e)),g=new U.ParamSet(f);return g.$$equals(b,c)}return!f.reload&&a===c&&(e===c.locals||a.self.reloadOnSearch===!1&&g(c,d,b))?!0:void 0}var x,y,z={},A={},B="abstract",C={parent:function(a){if(L(a.parent)&&a.parent)return m(a.parent);var b=/^(.+)\.[^.]+$/.exec(a.name);return b?m(b[1]):x},data:function(a){return a.parent&&a.parent.data&&(a.data=a.self.data=d(a.parent.data,a.data)),a.data},url:function(a){var b=a.url,c={params:a.params||{}};if(N(b))return"^"==b.charAt(0)?e.compile(b.substring(1),c):(a.parent.navigable||x).url.concat(b,c);if(!b||e.isMatcher(b))return b;throw new Error("Invalid url '"+b+"' in state '"+a+"'")},navigable:function(a){return a.url?a:a.parent?a.parent.navigable:null},ownParams:function(a){var b=a.url&&a.url.params||new U.ParamSet;return Q(a.params||{},function(a,c){b[c]||(b[c]=new U.Param(c,null,a,"config"))}),b},params:function(a){var b=l(a.ownParams,a.ownParams.$$keys());return a.parent&&a.parent.params?R(a.parent.params.$$new(),b):new U.ParamSet},views:function(a){var b={};return Q(L(a.views)?a.views:{"":a},function(c,d){d.indexOf("@")<0&&(d+="@"+a.parent.name),b[d]=c}),b},path:function(a){return a.parent?a.parent.path.concat(a):[]},includes:function(a){var b=a.parent?R({},a.parent.includes):{};return b[a.name]=!0,b},$delegates:{}};x=q({name:"",url:"^",views:null,abstract:!0}),x.navigable=null,this.decorator=t,this.state=u,this.$get=v,v.$inject=["$rootScope","$q","$view","$injector","$resolve","$stateParams","$urlRouter","$location","$urlMatcherFactory"]}function w(){function a(a,b){return{load:function(a,c){var d,e={template:null,controller:null,view:null,locals:null,notify:!0,async:!0,params:{}};return c=R(e,c),c.view&&(d=b.fromConfig(c.view,c.params,c.locals)),d}}}this.$get=a,a.$inject=["$rootScope","$templateFactory"]}function x(){var a=!1;this.useAnchorScroll=function(){a=!0},this.$get=["$anchorScroll","$timeout",function(b,c){return a?b:function(a){return c(function(){a[0].scrollIntoView()},0,!1)}}]}function y(a,c,d,e){function f(){return c.has?function(a){return c.has(a)?c.get(a):null}:function(a){try{return c.get(a)}catch(a){return null}}}function g(a,c){function d(a){return 1===V&&W>=4?!!j.enabled(a):1===V&&W>=2?!!j.enabled():!!i}var e={enter:function(a,b,c){b.after(a),c()},leave:function(a,b){a.remove(),b()}};if(a.noanimation)return e;if(j)return{enter:function(a,c,f){d(a)?b.version.minor>2?j.enter(a,null,c).then(f):j.enter(a,null,c,f):e.enter(a,c,f)},leave:function(a,c){d(a)?b.version.minor>2?j.leave(a).then(c):j.leave(a,c):e.leave(a,c)}};if(i){var f=i&&i(c,a);return{enter:function(a,b,c){f.enter(a,null,b),c()},leave:function(a,b){f.leave(a),b()}}}return e}var h=f(),i=h("$animator"),j=h("$animate"),k={restrict:"ECA",terminal:!0,priority:400,transclude:"element",compile:function(c,f,h){return function(c,f,i){function j(){function a(){b&&b.remove(),c&&c.$destroy()}var b=l,c=n;c&&(c._willBeDestroyed=!0),m?(r.leave(m,function(){a(),l=null}),l=m):(a(),l=null),m=null,n=null}function k(g){var k,l=A(c,i,f,e),s=l&&a.$current&&a.$current.locals[l];if((g||s!==o)&&!c._willBeDestroyed){k=c.$new(),o=a.$current.locals[l],k.$emit("$viewContentLoading",l);var t=h(k,function(a){r.enter(a,f,function(){n&&n.$emit("$viewContentAnimationEnded"),(b.isDefined(q)&&!q||c.$eval(q))&&d(a)}),j()});m=t,n=k,n.$emit("$viewContentLoaded",l),n.$eval(p)}}var l,m,n,o,p=i.onload||"",q=i.autoscroll,r=g(i,c);c.$on("$stateChangeSuccess",function(){k(!1)}),k(!0)}}};return k}function z(a,b,c,d){return{restrict:"ECA",priority:-400,compile:function(e){var f=e.html();return function(e,g,h){var i=c.$current,j=A(e,h,g,d),k=i&&i.locals[j];if(k){g.data("$uiView",{name:j,state:k.$$state}),g.html(k.$template?k.$template:f);var l=a(g.contents());if(k.$$controller){k.$scope=e,k.$element=g;var m=b(k.$$controller,k);k.$$controllerAs&&(e[k.$$controllerAs]=m),g.data("$ngControllerController",m),g.children().data("$ngControllerController",m)}l(e)}}}}}function A(a,b,c,d){var e=d(b.uiView||b.name||"")(a),f=c.inheritedData("$uiView");return e.indexOf("@")>=0?e:e+"@"+(f?f.state.name:"")}function B(a,b){var c,d=a.match(/^\s*({[^}]*})\s*$/);if(d&&(a=b+"("+d[1]+")"),c=a.replace(/\n/g," ").match(/^([^(]+?)\s*(\((.*)\))?$/),!c||4!==c.length)throw new Error("Invalid state ref '"+a+"'");return{state:c[1],paramExpr:c[3]||null}}function C(a){var b=a.parent().inheritedData("$uiView");return b&&b.state&&b.state.name?b.state:void 0}function D(a){var b="[object SVGAnimatedString]"===Object.prototype.toString.call(a.prop("href")),c="FORM"===a[0].nodeName;return{attr:c?"action":b?"xlink:href":"href",isAnchor:"A"===a.prop("tagName").toUpperCase(),clickable:!c}}function E(a,b,c,d,e){return function(f){var g=f.which||f.button,h=e();if(!(g>1||f.ctrlKey||f.metaKey||f.shiftKey||a.attr("target"))){var i=c(function(){b.go(h.state,h.params,h.options)});f.preventDefault();var j=d.isAnchor&&!h.href?1:0;f.preventDefault=function(){j--<=0&&c.cancel(i)}}}}function F(a,b){return{relative:C(a)||b.$current,inherit:!0}}function G(a,c){return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(d,e,f,g){var h=B(f.uiSref,a.current.name),i={state:h.state,href:null,params:null},j=D(e),k=g[1]||g[0];i.options=R(F(e,a),f.uiSrefOpts?d.$eval(f.uiSrefOpts):{});var l=function(c){c&&(i.params=b.copy(c)),i.href=a.href(h.state,i.params,i.options),k&&k.$$addStateInfo(h.state,i.params),null!==i.href&&f.$set(j.attr,i.href)};h.paramExpr&&(d.$watch(h.paramExpr,function(a){a!==i.params&&l(a)},!0),i.params=b.copy(d.$eval(h.paramExpr))),l(),j.clickable&&e.bind("click",E(e,a,c,j,function(){return i}))}}}function H(a,b){return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(c,d,e,f){function g(b){l.state=b[0],l.params=b[1],l.options=b[2],l.href=a.href(l.state,l.params,l.options),i&&i.$$addStateInfo(l.state,l.params),l.href&&e.$set(h.attr,l.href)}var h=D(d),i=f[1]||f[0],j=[e.uiState,e.uiStateParams||null,e.uiStateOpts||null],k="["+j.map(function(a){return a||"null"}).join(", ")+"]",l={state:null,params:null,options:null,href:null};c.$watch(k,g,!0),g(c.$eval(k)),h.clickable&&d.bind("click",E(d,a,b,h,function(){return l}))}}}function I(a,b,c){return{restrict:"A",controller:["$scope","$element","$attrs","$timeout",function(b,d,e,f){function g(b,c,e){var f=a.get(b,C(d)),g=h(b,c);p.push({state:f||{name:b},params:c,hash:g}),q[g]=e}function h(a,c){if(!N(a))throw new Error("state should be a string");return O(c)?a+T(c):(c=b.$eval(c),O(c)?a+T(c):a)}function i(){for(var a=0;a<p.length;a++)l(p[a].state,p[a].params)?j(d,q[p[a].hash]):k(d,q[p[a].hash]),m(p[a].state,p[a].params)?j(d,n):k(d,n)}function j(a,b){f(function(){a.addClass(b)})}function k(a,b){a.removeClass(b)}function l(b,c){return a.includes(b.name,c)}function m(b,c){return a.is(b.name,c)}var n,o,p=[],q={};n=c(e.uiSrefActiveEq||"",!1)(b);try{o=b.$eval(e.uiSrefActive)}catch(a){}o=o||c(e.uiSrefActive||"",!1)(b),O(o)&&Q(o,function(c,d){if(N(c)){var e=B(c,a.current.name);g(e.state,b.$eval(e.paramExpr),d)}}),this.$$addStateInfo=function(a,b){O(o)&&p.length>0||(g(a,b,o),i())},b.$on("$stateChangeSuccess",i),i()}]}}function J(a){var b=function(b,c){return a.is(b,c)};return b.$stateful=!0,b}function K(a){var b=function(b,c,d){return a.includes(b,c,d)};return b.$stateful=!0,b}var L=b.isDefined,M=b.isFunction,N=b.isString,O=b.isObject,P=b.isArray,Q=b.forEach,R=b.extend,S=b.copy,T=b.toJson;b.module("ui.router.util",["ng"]),b.module("ui.router.router",["ui.router.util"]),b.module("ui.router.state",["ui.router.router","ui.router.util"]),b.module("ui.router",["ui.router.state"]),b.module("ui.router.compat",["ui.router"]),p.$inject=["$q","$injector"],b.module("ui.router.util").service("$resolve",p),q.$inject=["$http","$templateCache","$injector"],b.module("ui.router.util").service("$templateFactory",q);var U;r.prototype.concat=function(a,b){var c={caseInsensitive:U.caseInsensitive(),strict:U.strictMode(),squash:U.defaultSquashPolicy()};return new r(this.sourcePath+a+this.sourceSearch,R(c,b),this)},r.prototype.toString=function(){return this.source},r.prototype.exec=function(a,b){function c(a){function b(a){return a.split("").reverse().join("")}function c(a){return a.replace(/\\-/g,"-")}var d=b(a).split(/-(?!\\)/),e=o(d,b);return o(e,c).reverse()}var d=this.regexp.exec(a);if(!d)return null;b=b||{};var e,f,g,h=this.parameters(),i=h.length,j=this.segments.length-1,k={};if(j!==d.length-1)throw new Error("Unbalanced capture group in route '"+this.source+"'");var l,m;for(e=0;j>e;e++){for(g=h[e],l=this.params[g],m=d[e+1],f=0;f<l.replace.length;f++)l.replace[f].from===m&&(m=l.replace[f].to);m&&l.array===!0&&(m=c(m)),L(m)&&(m=l.type.decode(m)),k[g]=l.value(m)}for(;i>e;e++){for(g=h[e],k[g]=this.params[g].value(b[g]),l=this.params[g],m=b[g],f=0;f<l.replace.length;f++)l.replace[f].from===m&&(m=l.replace[f].to);L(m)&&(m=l.type.decode(m)),k[g]=l.value(m)}return k},r.prototype.parameters=function(a){return L(a)?this.params[a]||null:this.$$paramNames},r.prototype.validates=function(a){return this.params.$$validates(a)},r.prototype.format=function(a){function b(a){return encodeURIComponent(a).replace(/-/g,function(a){return"%5C%"+a.charCodeAt(0).toString(16).toUpperCase()})}a=a||{};var c=this.segments,d=this.parameters(),e=this.params;if(!this.validates(a))return null;var f,g=!1,h=c.length-1,i=d.length,j=c[0];for(f=0;i>f;f++){var k=h>f,l=d[f],m=e[l],n=m.value(a[l]),p=m.isOptional&&m.type.equals(m.value(),n),q=p?m.squash:!1,r=m.type.encode(n);if(k){var s=c[f+1],t=f+1===h;if(q===!1)null!=r&&(j+=P(r)?o(r,b).join("-"):encodeURIComponent(r)),j+=s;else if(q===!0){var u=j.match(/\/$/)?/\/?(.*)/:/(.*)/;j+=s.match(u)[1]}else N(q)&&(j+=q+s);t&&m.squash===!0&&"/"===j.slice(-1)&&(j=j.slice(0,-1))}else{if(null==r||p&&q!==!1)continue;if(P(r)||(r=[r]),0===r.length)continue;r=o(r,encodeURIComponent).join("&"+l+"="),j+=(g?"&":"?")+(l+"="+r),g=!0}}return j},s.prototype.is=function(a,b){return!0},s.prototype.encode=function(a,b){return a},s.prototype.decode=function(a,b){return a},s.prototype.equals=function(a,b){return a==b},s.prototype.$subPattern=function(){var a=this.pattern.toString();return a.substr(1,a.length-2)},s.prototype.pattern=/.*/,s.prototype.toString=function(){return"{Type:"+this.name+"}"},s.prototype.$normalize=function(a){return this.is(a)?a:this.decode(a)},s.prototype.$asArray=function(a,b){function d(a,b){function d(a,b){return function(){return a[b].apply(a,arguments)}}function e(a){return P(a)?a:L(a)?[a]:[]}function f(a){switch(a.length){case 0:return c;case 1:return"auto"===b?a[0]:a;default:return a}}function g(a){return!a}function h(a,b){return function(c){if(P(c)&&0===c.length)return c;c=e(c);var d=o(c,a);return b===!0?0===n(d,g).length:f(d)}}function i(a){return function(b,c){var d=e(b),f=e(c);if(d.length!==f.length)return!1;for(var g=0;g<d.length;g++)if(!a(d[g],f[g]))return!1;return!0}}this.encode=h(d(a,"encode")),this.decode=h(d(a,"decode")),this.is=h(d(a,"is"),!0),this.equals=i(d(a,"equals")),this.pattern=a.pattern,this.$normalize=h(d(a,"$normalize")),this.name=a.name,this.$arrayMode=b}if(!a)return this;if("auto"===a&&!b)throw new Error("'auto' array mode is for query parameters only");return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",t),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),u.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",u),v.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").factory("$stateParams",function(){return{}}).provider("$state",v),w.$inject=[],b.module("ui.router.state").provider("$view",w),b.module("ui.router.state").provider("$uiViewScroll",x);var V=b.version.major,W=b.version.minor;y.$inject=["$state","$injector","$uiViewScroll","$interpolate"],z.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",y),b.module("ui.router.state").directive("uiView",z),G.$inject=["$state","$timeout"],H.$inject=["$state","$timeout"],I.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",G).directive("uiSrefActive",I).directive("uiSrefActiveEq",I).directive("uiState",H),J.$inject=["$state"],K.$inject=["$state"],b.module("ui.router.state").filter("isState",J).filter("includedByState",K)}(window,window.angular);var RetryHandler=function(){this.interval=1e3,this.maxInterval=6e4};RetryHandler.prototype.retry=function(a){setTimeout(a,this.interval),this.interval=this.nextInterval_()},RetryHandler.prototype.reset=function(){this.interval=1e3},RetryHandler.prototype.nextInterval_=function(){var a=2*this.interval+this.getRandomInt_(0,1e3);return Math.min(a,this.maxInterval)},RetryHandler.prototype.getRandomInt_=function(a,b){return Math.floor(Math.random()*(b-a+1)+a)};var MediaUploader=function(a){var b=function(){};if(this.file=a.file,this.contentType=a.contentType||this.file.type||"application/octet-stream",this.metadata=a.metadata||{title:this.file.name,mimeType:this.contentType},this.videoData=a.videoData,this.token=a.token,this.upgrade_to_1080=a.upgrade_to_1080,this.onComplete=a.onComplete||b,this.onProgress=a.onProgress||b,this.onError=a.onError||b,this.offset=a.offset||0,this.chunkSize=a.chunkSize||0,this.retryHandler=new RetryHandler,this.url=a.url,!this.url){var c=a.params||{};this.url=this.buildUrl_(a.fileId,c,a.baseUrl)}this.httpMethod=a.fileId?"PUT":"POST"};MediaUploader.prototype.upload=function(){var a=new XMLHttpRequest;a.open(this.httpMethod,this.url,!0),a.setRequestHeader("Authorization","Bearer "+this.token),a.setRequestHeader("Content-Type","application/json"),a.onload=function(a){if(a.target.status<400){var b=JSON.parse(a.target.responseText);this.url=b.upload_link_secure,this.user=b.user,this.ticket_id=b.ticket_id,this.complete_url="https://api.vimeo.com"+b.complete_uri,this.sendFile_()}else this.onUploadError_(a)}.bind(this),a.onerror=this.onUploadError_.bind(this),a.send(JSON.stringify({type:"streaming",upgrade_to_1080:this.upgrade_to_1080}))},MediaUploader.prototype.sendFile_=function(){var a=this.file,b=this.file.size;(this.offset||this.chunkSize)&&(this.chunkSize&&(b=Math.min(this.offset+this.chunkSize,this.file.size)),a=a.slice(this.offset,b));var c=new XMLHttpRequest;c.open("PUT",this.url,!0),c.setRequestHeader("Content-Type",this.contentType),c.setRequestHeader("Content-Range","bytes "+this.offset+"-"+(b-1)+"/"+this.file.size),c.upload&&c.upload.addEventListener("progress",this.onProgress),c.onload=this.onContentUploadSuccess_.bind(this),c.onerror=this.onContentUploadError_.bind(this),c.send(a)},MediaUploader.prototype.resume_=function(){var a=new XMLHttpRequest;a.open("PUT",this.url,!0),a.setRequestHeader("Content-Range","bytes */"+this.file.size),a.setRequestHeader("X-Upload-Content-Type",this.file.type),a.upload&&a.upload.addEventListener("progress",this.onProgress),a.onload=this.onContentUploadSuccess_.bind(this),a.onerror=this.onContentUploadError_.bind(this),a.send()},MediaUploader.prototype.extractRange_=function(a){var b=a.getResponseHeader("Range");b&&(this.offset=parseInt(b.match(/\d+/g).pop(),10)+1)},MediaUploader.prototype.complete_=function(){var a=new XMLHttpRequest;a.open("DELETE",this.complete_url,!0),a.setRequestHeader("Authorization","Bearer "+this.token),a.onload=function(a){if(a.target.status<400){var b=a.target.getResponseHeader("Location"),c=b.split("/").pop();this.onComplete(c),this.onUpdateVideoData_(c)}else this.onCompleteError_(a)}.bind(this),a.onerror=this.onCompleteError_.bind(this),a.send()},MediaUploader.prototype.onUpdateVideoData_=function(a){var b=this.buildUrl_(a,[],"https://api.vimeo.com/videos/"),c="PATCH",d=new XMLHttpRequest;d.open(c,b,!0),d.setRequestHeader("Authorization","Bearer "+this.token),d.send(this.buildQuery_(this.videoData))},MediaUploader.prototype.onContentUploadSuccess_=function(a){200==a.target.status||201==a.target.status?this.complete_():308==a.target.status&&(this.extractRange_(a.target),this.retryHandler.reset(),this.sendFile_())},MediaUploader.prototype.onContentUploadError_=function(a){a.target.status&&a.target.status<500?this.onError(a.target.response):this.retryHandler.retry(this.resume_.bind(this))},MediaUploader.prototype.onCompleteError_=function(a){this.onError(a.target.response)},MediaUploader.prototype.onUploadError_=function(a){this.onError(a.target.response)},MediaUploader.prototype.buildQuery_=function(a){return a=a||{},Object.keys(a).map(function(b){return encodeURIComponent(b)+"="+encodeURIComponent(a[b])}).join("&")},MediaUploader.prototype.buildUrl_=function(a,b,c){var d=c||"https://api.vimeo.com/me/videos";a&&(d+=a);var e=this.buildQuery_(b);return e&&(d+="?"+e),d},function(){angular.module("ninjaApp",["ui.router","ngAnimate"])}(),function(){angular.module("ninjaApp").config(["$urlRouterProvider","$stateProvider","$httpProvider",function(a,b,c){b.state("home",{url:"/home",templateUrl:"views/home.html",controller:"homeCtrl",authenticate:!0}).state("login",{url:"/",templateUrl:"views/users/login.html",controller:"loginCtrl"}).state("users",{url:"/users",templateUrl:"views/users/users.html",controller:"usersCtrl",authenticate:!0}).state("addUser",{url:"/user/add",templateUrl:"views/users/add-user.html",controller:"addUserCtrl",authenticate:!0}).state("editUser",{url:"/user/edit/:userId",templateUrl:"views/users/update-user.html",controller:"updateUserCtrl",authenticate:!0}).state("techniquesList",{url:"/techniques/:label",templateUrl:"views/techniques/techniques.html",controller:"techniquesListCtrl",authenticate:!0}).state("addTechnique",{url:"/technique/add",templateUrl:"views/techniques/add-technique.html",controller:"addTechniqueCtrl",authenticate:!0}).state("editTechnique",{url:"/technique/edit/:techniqueId",templateUrl:"views/techniques/update-technique.html",controller:"updateTechniqueCtrl",authenticate:!0}).state("techniqueDetail",{url:"/technique/:kyu/:techniqueId",templateUrl:"views/techniques/technique.html",controller:"techniqueDetailCtrl",authenticate:!0}),a.otherwise("/"),c.interceptors.push("authInterceptor")}]).run(["$rootScope","$http","$state","$templateCache","authToken",function(a,b,c,d,e){e.removeToken(),d.removeAll(),a.$on("$stateChangeStart",function(a,b,d,f,g){b.authenticate&&!e.isAuthenticated()&&(c.go("login"),a.preventDefault())}),a.loading=function(){return b.pendingRequests.length>0},a.isOnline=function(){return navigator.onLine}}]).constant("API_URL","http://mighty-headland-91771.herokuapp.com/api")}(),angular.module("ninjaApp").controller("addTechniqueCtrl",["$rootScope","$scope","$state","alert","techniques","techniqueData",function(a,b,c,d,e,f){b.technique={},b.setTechniqueImage=function(a,c){e.toDataURL(a,c,function(a){a?(b.technique.image=a,b.$apply()):d("danger","Images cannot be larger that 300kb")})},b.addTechnique=function(a){b.submitted=!0,a&&e.addTechnique(b.technique).then(function(a){f.techniques.push(a.data),d("success","A new technique has been added!")},function(a){d("danger","Could not connect to Ninja Server. Check your internet connection and try again.! ("+a+")")}).finally(function(){c.go("techniquesList",{label:b.technique.group})})},b.uploadVideo=function(){var a={files:document.getElementById("video").files,name:b.technique.name||"",description:b.technique.description||""};b.uploading=!0,b.$apply(),e.uploadVideo(a,function(a){b.uploading=!0,b.technique.videoUrl="https://player.vimeo.com/video/"+a,b.$apply()})}}]),angular.module("ninjaApp").controller("addUserCtrl",["$rootScope","$scope","$http","$state","alert","userData","auth","API_URL",function(a,b,c,d,e,f,g,h,i){b.isAdmin=g.currentUser.isAdmin,b.enabled=!0,b.addUser=function(a){b.submitted=!0,a&&(b.user.email=b.user.email.toLowerCase(),g.addUser(b.user).success(function(a){a.hasUser?e("danger",a.message):(f.users.push(a.user),e("success",b.user.firstName+" has been added!"),b.user={},d.go("users"))}).error(function(a){e("danger","Could not connect to Ninja Server. Check your internet connection and try again.!",5e3),b.user={},d.go("users")}))}}]),angular.module("ninjaApp").controller("homeCtrl",["$scope","$http","API_URL","auth","levelsData","coursesData","techniqueData",function(a,b,c,d,e,f,g){a.levels=e.levels,a.courses=f.courses,a.showCourses=0!=d.currentUser.courses.length,a.checkLevel=function(a){if(d.currentUser.level&&-1!=d.currentUser.level.indexOf("kyu")){var b=parseInt(a),c=parseInt(d.currentUser.level);return b>=c-1}return!0},a.countTechniques=function(a){var b=0;for(t in g.techniques)a==g.techniques[t].group&&(b+=1);return b},a.checkCourse=function(a){return-1!=d.currentUser.courses.indexOf(a)||d.currentUser.isAdmin||d.currentUser.isInstructor}}]),angular.module("ninjaApp").controller("loginCtrl",["$rootScope","$scope","$http","$state","auth","authToken","alert","techniqueData","userData",function(a,b,c,d,e,f,g,h,i){b.login=function(c){b.submitted=!0,c&&(b.loginUser.email=b.loginUser.email.toLowerCase(),e.login(b.loginUser).then(function(b){b.data.currentUser?(f.setToken(b.data.token),e.currentUser=b.data.currentUser,i.users=b.data.users,h.techniques=b.data.techniques,a.$broadcast("user"),g("success","Hey "+b.data.currentUser.firstName),d.go("home")):g("danger",b.data)},function(a){g("danger","Could not connect to Ninja Server. Check your internet connection and try again.!")}))}}]),angular.module("ninjaApp").controller("navbarCtrl",["$rootScope","$scope","$state","$document","auth","authToken",function(a,b,c,d,e,f){b.isAuthenticated=f.isAuthenticated,a.$on("user",function(){b.isInstructor=e.currentUser.isInstructor||e.currentUser.isAdmin,b.currentUser=e.currentUser}),d.on("click",function(a){angular.element(a.target).hasClass("navbar-toggle")||(b.showNav=!1,b.$apply())}),b.logout=function(){f.removeToken(),b.showNav=!1,c.go("login")}}]),angular.module("ninjaApp").controller("techniqueDetailCtrl",["$scope","$state","$stateParams","$sce","techniqueData","auth",function(a,b,c,d,e,f){a.kyu=c.kyu,a.isInstructor=f.currentUser.isInstructor,a.isAdmin=f.currentUser.isAdmin;for(t in e.techniques)e.techniques[t]._id==c.techniqueId&&(a.technique=e.techniques[t])}]).filter("trustAsResourceUrl",["$sce",function(a){return function(b){return a.trustAsResourceUrl(b+"?title=0&byline=0")}}]),angular.module("ninjaApp").controller("techniquesListCtrl",["$scope","$stateParams","techniqueData",function(a,b,c){a.techniques=c.techniques,a.label=b.label,setTimeout(function(){a.listItems=document.querySelectorAll(".list-group-item"),a.$apply()},500)}]),angular.module("ninjaApp").controller("updateTechniqueCtrl",["$rootScope","$scope","$state","$stateParams","alert","techniqueData","techniques","auth",function(a,b,c,d,e,f,g,h){b.kyu=d.kyu,b.isAdmin=h.currentUser.isAdmin;for(t in f.techniques)f.techniques[t]._id==d.techniqueId&&(b.technique=f.techniques[t],b.viewingTechnique=f.techniques[t]);b.setTechniqueImage=function(a,c){g.toDataURL(a,c,function(a){a?(b.technique.image=a,b.$apply()):e("danger","Images cannot be larger that 200kb")})},b.updateTechnique=function(a){if(b.submitted=!0,a)for(t in f.techniques)if(f.techniques[t]._id==d.techniqueId){var h=t;f.techniques[t].image=b.technique.image,console.log(f.techniques[t].image),g.updateTechnique(f.techniques[t]).then(function(a){e("success","The technique has been updated!")},function(a){e("danger","Could not connect to Ninja Server. Check your internet connection and try again.!")}).finally(function(){c.go("techniqueDetail",{kyu:f.techniques[h].group,techniqueId:f.techniques[h]._id}),b.technique={}})}},b.uploadVideo=function(){var a={files:document.getElementById("video").files,name:b.technique.name||"",description:b.technique.description||""};b.uploading=!0,b.$apply(),g.uploadVideo(a,function(a){b.technique.videoUrl="https://player.vimeo.com/video/"+a,b.uploading=!1,b.$apply()})},b.deleteTechnique=function(){for(t in f.techniques)if(f.techniques[t]._id==d.techniqueId){var a=t;g.removeTechnique(f.techniques[t]).then(function(b){e("success",'"'+f.techniques[a].name+'" has been deleted!'),f.techniques.splice(a,1)},function(a){e("danger","Could not connect to Ninja Server. Check your internet connection and try again.!")}).finally(function(){b.technique={}})}}}]),angular.module("ninjaApp").controller("updateUserCtrl",["$rootScope","$scope","$stateParams","$state","alert","userData","auth",function(a,b,c,d,e,f,g){var h;b.isEditingUser=!0,b.isAdmin=g.currentUser.isAdmin,b.isInstructor=g.currentUser.isInstructor;for(usr in f.users)f.users[usr]._id==c.userId&&(h=usr,b.user=f.users[usr]);b.enabled=b.isAdmin||g.currentUser._id===c.userId||b.isInstructor&&!b.user.isInstructor,b.isStudent=!b.isInstructor&&!b.isAdmin,b.updateUser=function(a){b.submitted=!0,a&&g.updateUser(b.user).then(function(a){e("success",a.data.firstName+" has been updated!")},function(a){e("danger","Could not connect to Ninja Server. Check your internet connection and try again.!",5e3)}).finally(function(){d.go("users"),b.user={}})},b.removeUser=function(){var a=b.user.firstName;g.removeUser(b.user._id).then(function(b){var c=a||"Ninja";e("success",c+" has been removed!"),f.users.splice(h,1)},function(a){e("danger","Could not connect to Ninja Server. Check your internet connection and try again.!",5e3)}).finally(function(){d.go("users"),b.user={}})}}]),angular.module("ninjaApp").controller("usersCtrl",["$scope","$http","userData",function(a,b,c){a.users=c.users}]),angular.module("ninjaApp").filter("groupBy",function(){var a=function(a,b){for(var c=[],d=0;d<a.length;d++){var e=a[d][b];-1==c.indexOf(e)&&c.push(e);
}return c};return function(b,c){return null!==b?a(b,c):void 0}}),angular.module("ninjaApp").service("alert",["$rootScope","$timeout",function(a,b){var c;return function(d,e,f){a.alert={hasBeenShown:!0,show:!0,type:d,message:e},b.cancel(c),c=b(function(){a.alert.show=!1},f||2500)}}]),angular.module("ninjaApp").service("auth",["$http","$state","API_URL","authToken",function(a,b,c,d){this.currentUser={},this.login=function(b){return a.post(c+"/login",b)},this.addUser=function(b,d){return a.post(c+"/user",b)},this.updateUser=function(b){return a.put(c+"/user",b)},this.removeUser=function(b){return a.delete(c+"/user/?id="+b)}}]),angular.module("ninjaApp").factory("authInterceptor",["authToken",function(a){return{request:function(b){var c=a.getToken();return c&&(b.headers.Authorization=c),b},response:function(a){return a}}}]),angular.module("ninjaApp").factory("authToken",["$window",function(a){var b,c=a.sessionStorage,d="NinjaSA_Token",e={getToken:function(){return b||(b=c.getItem(d)),b},setToken:function(a){b=a,c.setItem(d,a)},removeToken:function(){b=null,c.removeItem(d)},isAuthenticated:function(){return!!e.getToken()}};return e}]),angular.module("ninjaApp").service("userData",function(){this.users=[]}).service("techniqueData",function(){this.techniques=[]}).service("levelsData",function(){this.levels=[{title:"9th-kyu",description:"Deflections, Stances, Elements, Jutai jutsu"},{title:"8th-kyu",description:"Atemi Jutsu , Kicks, Jutai Jutsu"},{title:"7th-kyu",description:"Takedowns, Locks, Jutai Jutsu"},{title:"6th-kyu",description:"Body-holds, Pain Compliance, Gun Hold-ups"},{title:"5th-kyu",description:"Knife defence, Ninja Keyring"},{title:"4th-kyu",description:"Jojutsu (Short stick), Tonfa PR24"},{title:"3rd-kyu",description:"Hanbojutsu (Med Staff), Kali"},{title:"2nd-kyu",description:"Nunchaku and Belt Work (Chain)"},{title:"1st-kyu",description:"Single Arm fighting and Ninjato (Katas)"}]}).service("coursesData",function(){this.courses=["sai","kukri","archery","grappling"]}),angular.module("ninjaApp").service("techniques",["$http","$state","API_URL",function(a,b,c){function d(a){a=Math.floor(100*a);var b=document.getElementById("progress");b.setAttribute("style","width:"+a+"%"),b.innerHTML=a+"%"}this.addTechnique=function(b){return a.post(c+"/technique",b)},this.updateTechnique=function(b){return a.put(c+"/technique",b)},this.removeTechnique=function(b){return a.delete(c+"/technique?id="+b._id)},this.toDataURL=function(a,b,c){var d,e=a.files[0],f=new FileReader;return e.size>3e5?(c(!1),!1):(f.onload=function(a){d=a.target.result;var e=new Image;e.onload=function(){var a=document.createElement("canvas");a.width=this.width,a.height=this.height,a.getContext("2d").drawImage(this,0,0,this.width,this.height),c&&c(a.toDataURL()),document.querySelector(b).src=a.toDataURL()},e.src=d},void f.readAsDataURL(e))},this.uploadVideo=function(a,b){d(0);var c=new MediaUploader({file:a.files[0],token:"09c88211df6bc5b18277d567f47c8f15",upgrade_to_1080:!1,videoData:{name:a.name,description:a.description},onError:function(a){var b=JSON.parse(a);message=b.error},onProgress:function(a){d(a.loaded/a.total)},onComplete:function(a){b(a)}});c.upload()}}]);